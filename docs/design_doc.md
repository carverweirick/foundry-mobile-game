...
*Captured verbatim-in-spirit from a design conversation, not yet implemented - explicitly deferred per direct instruction ("don't make any changes to the game right now, let's just document these ideas"). Same purpose as Sections 21-23: get the reasoning and scope down in one place before any of it gets built, so a future session isn't reconstructing intent from scratch. These are real extensions of Sections 8, 9, and 10 - where this section adds detail or changes a number, it should be read as an amendment to those sections, not a contradiction.*

### 24.1 Contracts as multiple line items, not one geometry each
...
### 24.3 A much larger, visually distinct real geometry roster
...
### 24.9 Reputation/familiarity can gate whether a customer will even offer a contract - and a way to actively earn access
...
### 24.10 The open problem: displaying all of this without burying the player
